    ...
    <div className="bg-white border border-gray-200 shadow-xl rounded-3xl p-6 sticky top-24">
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-2xl border border-gray-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-medium text-sm text-black">💳 Secure Online Payment</p>
            <p className="text-xs text-gray-500">UPI, Cards, NetBanking via Razorpay</p>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs text-green-600">✓ 100% Secure</span>
              <span className="text-xs text-gray-300">|</span>
              <span className="text-xs text-green-600">✓ Instant Confirmation</span>
            </div>
          </div>
        </div>
      </div>
